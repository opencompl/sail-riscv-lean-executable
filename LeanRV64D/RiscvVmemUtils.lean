...
/-- Type quantifiers: k_ex373928# : Bool, k_ex373927# : Bool, k_ex373926# : Bool, width : Nat, is_mem_width(width) -/
...
/-- Type quantifiers: k_ex373979# : Bool, k_ex373978# : Bool, k_ex373977# : Bool, width : Nat, is_mem_width(width) -/
...
/-- Type quantifiers: k_ex374014# : Bool, k_ex374013# : Bool, k_ex374012# : Bool, width : Nat, is_mem_width(width) -/
