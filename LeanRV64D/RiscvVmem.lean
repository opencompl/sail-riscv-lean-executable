...
/-- Type quantifiers: k_ex371624# : Bool, level : Nat, k_ex371622# : Bool, k_ex371621# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex371669# : Bool, k_ex371668# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex371693# : Bool, k_ex371692# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex371732# : Bool, k_ex371731# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
