...
/-- Type quantifiers: k_ex373151# : Bool, level : Nat, k_ex373149# : Bool, k_ex373148# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex373196# : Bool, k_ex373195# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex373220# : Bool, k_ex373219# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex373259# : Bool, k_ex373258# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
