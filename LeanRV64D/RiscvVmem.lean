...
/-- Type quantifiers: k_ex371979# : Bool, level : Nat, k_ex371977# : Bool, k_ex371976# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex372024# : Bool, k_ex372023# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex372048# : Bool, k_ex372047# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex372087# : Bool, k_ex372086# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
