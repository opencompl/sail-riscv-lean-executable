...
/-- Type quantifiers: k_ex376052# : Bool, level : Nat, k_ex376050# : Bool, k_ex376049# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex376097# : Bool, k_ex376096# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex376118# : Bool, k_ex376117# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex376154# : Bool, k_ex376153# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
