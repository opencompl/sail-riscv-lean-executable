...
/-- Type quantifiers: k_ex374889# : Bool, level : Nat, k_ex374887# : Bool, k_ex374886# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex374934# : Bool, k_ex374933# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex374955# : Bool, k_ex374954# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex374991# : Bool, k_ex374990# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
