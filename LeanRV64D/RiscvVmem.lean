...
/-- Type quantifiers: k_ex373704# : Bool, level : Nat, k_ex373702# : Bool, k_ex373701# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex373749# : Bool, k_ex373748# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex373773# : Bool, k_ex373772# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex373812# : Bool, k_ex373811# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
