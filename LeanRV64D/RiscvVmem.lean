...
/-- Type quantifiers: k_ex374873# : Bool, level : Nat, k_ex374871# : Bool, k_ex374870# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex374918# : Bool, k_ex374917# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex374939# : Bool, k_ex374938# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex374975# : Bool, k_ex374974# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
