...
/-- Type quantifiers: k_ex372844# : Bool, level : Nat, k_ex372842# : Bool, k_ex372841# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex372889# : Bool, k_ex372888# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex372913# : Bool, k_ex372912# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex372952# : Bool, k_ex372951# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
