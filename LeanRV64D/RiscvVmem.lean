...
/-- Type quantifiers: k_ex372820# : Bool, level : Nat, k_ex372818# : Bool, k_ex372817# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex372865# : Bool, k_ex372864# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex372889# : Bool, k_ex372888# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex372928# : Bool, k_ex372927# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
