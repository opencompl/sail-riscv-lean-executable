...
/-- Type quantifiers: k_ex373281# : Bool, level : Nat, k_ex373279# : Bool, k_ex373278# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex373326# : Bool, k_ex373325# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex373347# : Bool, k_ex373346# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex373383# : Bool, k_ex373382# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
