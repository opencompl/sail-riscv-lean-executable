...
/-- Type quantifiers: k_ex373213# : Bool, level : Nat, k_ex373211# : Bool, k_ex373210# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex373258# : Bool, k_ex373257# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex373282# : Bool, k_ex373281# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex373321# : Bool, k_ex373320# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
